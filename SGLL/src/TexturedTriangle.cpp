...
namespace SGLL
{
	TexturedTriangle::TexturedTriangle(const glm::vec3& position, const glm::vec3& scale, const std::string& texturePath, const glm::vec3& color, const glm::vec3& rotation)
